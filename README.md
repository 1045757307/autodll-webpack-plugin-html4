...
This installation package is developed based on [autodll-webpack-plugin](https://github.com/asfktz/autodll-webpack-plugin),<br>
In order to solve the problem that html-webpack-plugin 4.0 and above does not have htmlWebpackPluginBeforeHtmlGeneration, which causes html injection to fail.

<hr>

# AutoDllPlugin

Webpack's DllPlugin without the boilerplate, compatible with html-webpack-plugin 4.0 and above.
Only supports webpack 4.

```
  npm install --save-dev autodll-webpack-plugin-html4
```
...
const AutoDllPlugin = require('autodll-webpack-plugin-html4');
